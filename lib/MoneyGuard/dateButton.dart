...
void dispose() {
  ...
  Future<void> _fetchTransactions() async {
    ...
    try {
      ...
      // Filtere Konten basierend auf der Auswahl
      ...
      // Iteriere über gefilterte Bankkonten und hole die Transaktionen
      for (final account in filteredBankAccounts) {
        // Lade alle Transaktionen des Kontos
        ...
        for (var transaction in accountTransactions) {
          ...
          transaction.bankAccount = account; // Verknüpfe die Bankkonto-Daten
        }
